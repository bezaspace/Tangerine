...
export default function BookScreen() {
  ...
  const practitionerId = parseInt(id as string);
  const { practitioner: selectedPractitioner, loading, error } = usePractitioner(practitionerId);
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.loadingContainer}>
          ...
          <Text style={styles.loadingText}>Loading practitioner details...</Text>
        </View>
      </SafeAreaView>
    );
  }

  if (error || !selectedPractitioner) {
    return (
      <SafeAreaView style={styles.container}>
